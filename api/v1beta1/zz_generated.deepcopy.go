...
func (in *CustomDomainStatus) DeepCopyInto(out *CustomDomainStatus) {
	*out = *in
	if in.Registrations != nil {
		in, out := &in.Registrations, &out.Registrations
		*out = make([]CustomDomainStatusRegistration, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CustomDomainStatusRegistration) DeepCopyInto(out *CustomDomainStatusRegistration) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CustomDomainStatusRegistration.
func (in *CustomDomainStatusRegistration) DeepCopy() *CustomDomainStatusRegistration {
	if in == nil {
		return nil
	}
	out := new(CustomDomainStatusRegistration)
	in.DeepCopyInto(out)
	return out
}
